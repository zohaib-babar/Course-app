      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1  lg:grid-cols-3 gap-10">
          ...
          <div className="p-8 bg-gray-900 rounded-2xl border border-gray-800 hover:border-blue-500 transition duration-300 shadow-lg hover:shadow-blue-500/20">
            <div className="text-4xl mb-4"><img className="h-[200px] rounded-full mx-auto" src="https://media-sin6-3.cdn.whatsapp.net/v/t61.24694-24/566604745_2281732702340747_2540773971918354555_n.jpg?ccb=11-4&oh=01_Q5Aa3QG62U-He_OhUZInHdo9e-r5recxiwDSZbTzkBv9Jvk-wQ&oe=696754A7&_nc_sid=5e03e0&_nc_cat=101" alt="" /></div>
          ...
          {/* Card 2 */}
          <div className="p-8 bg-gray-900 rounded-2xl border border-gray-800 hover:border-blue-500 transition duration-300 shadow-lg hover:shadow-blue-500/20">
            <div className="text-4xl mb-4"><img className="h-[200px] rounded-full mx-auto" src="https://pps.whatsapp.net/v/t61.24694-24/511343388_2325315601204098_3038077887394713738_n.jpg?ccb=11-4&oh=01_Q5Aa3QGigifNvXcqFhEPWPsU8V0mlx1EzL01ODkA_LTVbKnoUg&oe=69666F9C&_nc_sid=5e03e0&_nc_cat=109" alt="" /></div>
