      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-14">
          ...
          <p className="mt-3 text-gray-400 text-lg">
            High-<span className="text-blue-500">quality</span> services to bring your ideas to life.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          <div className="p-8 bg-gray-900 rounded-2xl border border-gray-800 hover:border-blue-500 transition duration-300 shadow-lg hover:shadow-blue-500/20">
            ...
            <h3 className="text-2xl font-semibold mb-3">Backened Services</h3>
            <p className="text-gray-400">
              Reliable and efficient infrastructure that keeps your app running smoothly.
            </p>
          </div>
